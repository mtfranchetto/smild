...
var JSTask = function (buildHelper) {
    Task.call(this, buildHelper);
};

inherits(JSTask, Task);

JSTask.prototype.command = "js";
JSTask.prototype.availableToModule = false;
JSTask.prototype.action = function () {
