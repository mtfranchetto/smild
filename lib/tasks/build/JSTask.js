...
const Task = require('../Task'),
    ...
    TypescriptParser = require('../../TypescriptParser'),
    _ = require('lodash');
...
class JSTask extends Task {
    ...
    action() {
        ...
        if (smildOptions.typescript) {
            bundleStream = bundleStream.plugin(tsify, TypescriptParser.parse().compilerOptions);
        }
        if (smildOptions.babel) {
            bundleStream = bundleStream.transform(babelify, _.merge({
                "presets": [
                    path.resolve(__dirname, "../../../node_modules/babel-preset-es2015"),
                    path.resolve(__dirname, "../../../node_modules/babel-preset-stage-1")
                ],
                "plugins": [
                    path.resolve(__dirname, "../../../node_modules/babel-plugin-transform-es2015-function-name")
                ]
            }, smildOptions.babel));
        }
